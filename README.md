# Serious Sam: Shatterverse Guide

Production game guide hub for **Serious Sam: Shatterverse** (site id
`serioussamshatterverse-pro`, exact domain `serioussamshatterverse.pro`).
This repository was generated by `one-click-builder` from the shared V3 game-guide
template; see `site-launch/roles/one-click-builder/agent.md` for the role workflow.
